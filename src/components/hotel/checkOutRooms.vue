								...
								<tr>
									<td>
										<div class="wrapper clx">
											...
											<div class="mb5 clx">
												<div class="fl">
													<select v-model="curPayList[0].type" style="width:72px;font-size:12px;float: left; margin-right:0; border-right:0;" >
														<option value="0" selected="selected">添加收款</option>
														<option value="2">退房费</option>
													</select>
