<template>
  <div class="main">
    ...
    <div class="inn-name">
      <h2>翰林客栈管理系统</h2>
      <p><span class="user">ID:9527</span><span tag="regards">，</span>&nbsp;&nbsp;<a href="javascript:;">登出</a></p>
    </div>
    <div class="logo"><a href=""><span class="logo_big"></span></a></div>
    <div id="sub-nav">
      ...
      <a :class="{'active':isurl('/log')}" v-link="{ path: '/log' }">日志</a>
